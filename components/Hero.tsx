...
export function Hero() {
  ...
  return (
    <section id="top" className="relative w-full overflow-hidden bg-ink text-white">
      ...
      <div className="relative mx-auto flex min-h-[92vh] flex-col justify-end px-6 pb-[14vh] pt-28 md:px-[11%]">
        ...
        <div className="mt-12 flex flex-wrap gap-[27px]">
          ...
          <ArrowButton href={nav[1].href} variant="filled">For Diners</ArrowButton>
        </div>
      </div>
    </section>
  );
